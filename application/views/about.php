...
<!-- management -->
<section style="background-color: #e7f0f6;">
    <div class="container space-y">
        <div class="row">
            <div class="col-md-2"></div>
            <div class="col-md-8 text-center">
                <h5 class="tag2">MANAGEMENT</h5>
                <p class="p-para mspace">ADMOG Holding Corp. is backed and managed by professionals with multidecade combined experience and a successful track-record in both the natural resources and the capital market industries.</p>
            </div>
            <div class="col-md-2"></div>
        </div>
        <div class="row space d-flex justify-content-around">
            ...
            <div class="col-md-3 text-center">
                ...
                <p class="u corporate pt-1">Chief Operation Officer</p>
            </div>
            ...
            <div class="col-md-2 text-center">
                <div class="circle ">
                    <img src="assets/img/corporate4.png" alt="">
                </div>
